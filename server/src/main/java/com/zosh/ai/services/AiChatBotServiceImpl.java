                                        ...
                                        .put(new JSONObject()
                                                .put("functionCall", new JSONObject()
                                                         ...
                                                         .put("args", new JSONObject()
                                                                 .put("cart", (Object)(functionResponse.getUserCart()!=null?functionResponse.getUserCart().getUser():null))
                                                                 .put("order", (Object)(functionResponse.getOrderHistory()!=null? functionResponse.getOrderHistory() :null))
                                                                 .put("product", (Object)(functionResponse.getProduct()!=null?ProductMapper.toProductDto(functionResponse.getProduct()):null))
                                                         )
                                                )
                                        )
                                )
                                        ...
                                        .put(new JSONObject()
                                                .put("functionResponse", new JSONObject()
                                                         ...
                                                         .put("response", new JSONObject()
                                                                 .put("name", functionResponse.getFunctionName())
                                                                 .put("content", (Object)functionResponse)
                                                         )
                                                )
                                        )
                                )
