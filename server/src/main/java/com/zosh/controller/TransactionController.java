...
public class TransactionController {
    ...
    @PostMapping
    public ResponseEntity<Transaction> createTransaction(@RequestBody Order order ,@RequestBody PaymentRecord paymentRecord) {
        Transaction transaction = transactionService.createTransaction(order, paymentRecord);
